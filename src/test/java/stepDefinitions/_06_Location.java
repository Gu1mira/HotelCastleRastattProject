...
public class _06_Location {
    ...
    public void navigateToHotelCastleRastattInGerman() {
        ...
        driver.get("https://hotel-castle-rastatt.de/");

        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(15));

        // Cookie uyarısı varsa kapat
        try {
            WebElement cookieAccept = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[aria-label='Akzeptieren']")));
            cookieAccept.click();
